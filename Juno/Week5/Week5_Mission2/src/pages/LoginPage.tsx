  ...
  return (
    <div className="flex flex-col justify-center items-center h-full gap-4">
      <div className="flex flex-col gap-3 relative">
        <span
          onClick={() => navigate(`/`)}
          className="text-2xl font-bold py-3 px-1 absolute cursor-pointer"
        >
          {"<"}
        </span>
        <span className="text-xl font-bold p-4 text-center">로그인</span>
        <input
          {...getInputProps("email")}
          name="email"
          className={`border border-[#ccc] w-[300px] p-2.5 focus:border-[#807bff] rounded-sm
            ${
